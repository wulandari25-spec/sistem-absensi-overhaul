...
<html lang="id" 
      x-data="{ 
          ...
          isCollapsed: localStorage.getItem('sidebarCollapsed') === 'true' && window.innerWidth >= 1024,
          toggleSidebar() {
              this.sidebarCollapsed = !this.sidebarCollapsed;
              localStorage.setItem('sidebarCollapsed', this.sidebarCollapsed);
              this.isCollapsed = this.sidebarCollapsed && window.innerWidth >= 1024;
          },
          init() {
              this.isCollapsed = this.sidebarCollapsed && window.innerWidth >= 1024;
          }
      }" 
      @resize.window="isCollapsed = sidebarCollapsed && window.innerWidth >= 1024"
      :class="{ 'dark': darkMode }">
<head>
    <meta charset="UTF-8">
